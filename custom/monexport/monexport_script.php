...
/**
 *      \file       monexport/monexport_script.php
 *		\ingroup    monexport
...
// Examples for manipulating class monexport_class
require_once(DOL_DOCUMENT_ROOT."/../monexport/monexport.class.php");
$myobject=new Monexport($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."monexport";

 ...
 */
class modSecureUserFree extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
        ...
        $this->db = $db;
        //$langs->load("mylangfile@secureuserfree");

		// Id for module (must be unique).
		// Use here a free id (See in Home -> System information -> Dolibarr for list of used modules id).
		$this->numero = 542214;
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'modSecureUserFree';
        ...
        $this->description = "Check if users accounts are safty. A Hacker could be still password !";
		...
		$this->config_page_url = array("mysetuppage.php@secureuserfree");
		...
		$this->langfiles = array("mylangfile@secureuserfree");
		...
		//		$this->tabs = array('categories_3:tabmodTest1:@test:mylangfile@test:1:/test/index.php?id=__ID__');
        ...
        */
		...
		$this->menu[$r]=array('fk_menu'=>0,// Put 0 if this is a top menu
				      ...
				      'titre'=>'SecureUserFree',
				      'mainmenu'=>'secureuserfree',
				      'leftmenu'=>'secureuserfree',
				      'url'=>'/secureuserfree/index.php',
				      'langs'=>'mylangfile@secureuserfree',// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
				      'position'=>100,

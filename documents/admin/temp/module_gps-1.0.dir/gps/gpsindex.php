...
/**
 *    \file       htdocs/gps/template/gpsindex.php
 *    \ingroup    gps
 *    \brief      Home page of gps top menu
 */
...
$langs->loadLangs(array("gps@gps"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->gps->read) {
    accessforbidden();
}
...
llxHeader("", $langs->trans("GpsArea"));

print load_fiche_titre($langs->trans("GpsArea"), '', 'gps.png@gps');
...
// Draft MyObject
if (! empty($conf->gps->enabled) && $user->rights->gps->read)
{
	$langs->load("orders");

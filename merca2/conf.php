...
// * or when using nginx (autodetect fails)
 ...
 $app ="merca2";
 $dominio = "http://localhost/merca2/";
 //$dominio = "http://localhost/credito";
 $dominio_server = "http://localhost/";
...
$host="192.185.128.14";
$userDatabase="portalxn_sarp";
$passDatabase="f11235813";
$directorioNoFoundImage = "#";
...
// CONFIGURACION CLOUD FIRESTORE
if(!defined('PROJECT_ID')) define('PROJECT_ID',$projectId);
if(!defined('KEY_FILE_PATH')) define('KEY_FILE_PATH',$keyFilePath);
...
//Todas las rutas definidas que terminan en _SERVER son para importar o incluir archivos de manera extar ,es decir que soporta rutas absolutas.como ejemplo archivos .js , .css , .jpg .ico .png etc.
 ...
 if (!defined('ROOT_PATH')) define('ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/'.'merca2/');
